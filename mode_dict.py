...
MODE_DICT = [
    ...
    Mode(3, InSeasonalHistoryWidget, "Внутрисезонная история отловов кольца", "(Здесь будет описание)"),
    Mode(4, None, "Межсезонная история отловов кольца", "(Здесь будет описание)"),
