...
class TimeSeriesOfAccumulatedNumbersWidget(QWidget):

    def __init__(self):
        super(TimeSeriesOfAccumulatedNumbersWidget, self).__init__()
        uic.loadUi('ui/time_series_of_accumulated_numbers.ui', self)
        self.data = []
