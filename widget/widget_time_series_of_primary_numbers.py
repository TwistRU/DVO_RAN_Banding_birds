...
class TimeSeriesOfPrimaryNumbersWidget(QWidget):

    def __init__(self):
        super(TimeSeriesOfPrimaryNumbersWidget, self).__init__()
        uic.loadUi('ui/time_series_of_primary_numbers.ui', self)
        self.data = []
